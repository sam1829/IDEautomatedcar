...
#if !defined(MK63F12_H_)
#define MK63F12_H_                               /**< Symbol preventing repeated inclusion */

#endif  /* #if !defined(MK63F12_H_) */
...
#if !defined(MCU_MK63F12)  /* Check if memory map has not been already included */
#define MCU_MK63F12

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK63F12 memory map: There is already included another memory map. Only one memory map can be included.
...
#include "system_MK63F12.h"            /* Device specific configuration file */
